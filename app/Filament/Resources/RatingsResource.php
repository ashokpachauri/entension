...
class RatingsResource extends Resource
{
    protected static ?string $model = Ratings::class;
        ...
        return $form
            ->schema([
                ...
                Forms\Components\Select::make('posts_id')
                    ->options(Posts::query()->pluck('title', 'id'))
                    ->live()
                    ->required(),
    ...
    public static function getPages(): array
    {
        return [
            ...
            'view' => Pages\ViewRatings::route('/{record}'),
